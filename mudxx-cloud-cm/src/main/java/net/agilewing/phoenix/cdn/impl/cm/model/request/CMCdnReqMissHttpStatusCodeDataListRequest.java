 ...
 */
@ApiModel("请求参数-查询回源状态码请求数,回源状态码请求数占比数据")
public class CMCdnReqMissHttpStatusCodeDataListRequest implements Serializable {
    private static final long serialVersionUID = 5649381963971930270L;
    ...
    public CMCdnReqMissHttpStatusCodeDataListRequest() {
    }

    private CMCdnReqMissHttpStatusCodeDataListRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CMCdnReqMissHttpStatusCodeDataListRequest build() {
            return new CMCdnReqMissHttpStatusCodeDataListRequest(this);
        }
    }
}
