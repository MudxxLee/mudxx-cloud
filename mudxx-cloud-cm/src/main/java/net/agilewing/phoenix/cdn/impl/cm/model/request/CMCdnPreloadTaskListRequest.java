 ...
 */
@ApiModel("请求参数-查询预热任务")
public class CMCdnPreloadTaskListRequest implements Serializable {
    ...
    public CMCdnPreloadTaskListRequest() {
    }

    private CMCdnPreloadTaskListRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CMCdnPreloadTaskListRequest build() {
            return new CMCdnPreloadTaskListRequest(this);
        }
    }
}
