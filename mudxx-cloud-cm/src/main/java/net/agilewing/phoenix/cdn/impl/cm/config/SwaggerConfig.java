package net.agilewing.phoenix.cdn.impl.cm.config;
...
public class SwaggerConfig {
	...
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apiInfo(apiInfo())
				.select()
				.apis(RequestHandlerSelectors.basePackage("net.agilewing"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Agilewing GoAllPayment API Guide")
				.build();
	}
    ...
    public static class SwaggerResourceController implements InitializingBean {
        ...
        @Autowired
        private PluginRegistry<WebMvcSwaggerTransformationFilter, DocumentationType> transformations;
