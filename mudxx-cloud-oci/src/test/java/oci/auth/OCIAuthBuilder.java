 ...
 */
public class OCIAuthBuilder {

    public static AuthenticationDetailsProvider getProvider() {
        return OCIAuthProvider.buildProvider(getProviderModel(), Region.AP_SEOUL_1);
    }

    public static OCIAuthenticationModel getProviderModel() {
        /**
        ...
        String tenantId = "ocid1.tenancy.oc1..aaaaaaaambezyu2ogbzgxcgy2ni3e6ik7uzr4irlrrm7clbuargwmfsk2woa";
        String privateKey = "-----BEGIN PRIVATE KEY-----\n" +
                ...
                "-----END PRIVATE KEY-----";
        return new OCIAuthenticationModel.Builder()
                .userId(userId)
                .tenantId(tenantId)
