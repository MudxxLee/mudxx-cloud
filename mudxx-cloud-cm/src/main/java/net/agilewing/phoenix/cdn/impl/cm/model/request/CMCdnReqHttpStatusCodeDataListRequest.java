 ...
 */
@ApiModel("请求参数-查询状态码请求数，请求状态码占比")
public class CMCdnReqHttpStatusCodeDataListRequest implements Serializable {
    ...
    public CMCdnReqHttpStatusCodeDataListRequest() {
    }

    private CMCdnReqHttpStatusCodeDataListRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CMCdnReqHttpStatusCodeDataListRequest build() {
            return new CMCdnReqHttpStatusCodeDataListRequest(this);
        }
    }
}
