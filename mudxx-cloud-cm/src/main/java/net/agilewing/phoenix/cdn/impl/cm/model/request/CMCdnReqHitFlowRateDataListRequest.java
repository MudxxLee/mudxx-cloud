 ...
 */
@ApiModel("请求参数-查询流量，命中流量，流量命中率，回源流量数据")
public class CMCdnReqHitFlowRateDataListRequest implements Serializable {
    ...
    public CMCdnReqHitFlowRateDataListRequest() {
    }

    private CMCdnReqHitFlowRateDataListRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CMCdnReqHitFlowRateDataListRequest build() {
            return new CMCdnReqHitFlowRateDataListRequest(this);
        }
    }
}
